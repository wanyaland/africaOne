...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Business.business_photos'
        db.delete_column(u'core_business', 'business_photos_id')

        # Adding field 'BusinessPhoto.business'
        db.add_column(u'core_businessphoto', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Business'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Business.business_photos'
        db.add_column(u'core_business', 'business_photos',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BusinessPhoto'], null=True),
                      keep_default=False)

        # Deleting field 'BusinessPhoto.business'
        db.delete_column(u'core_businessphoto', 'business_id')
