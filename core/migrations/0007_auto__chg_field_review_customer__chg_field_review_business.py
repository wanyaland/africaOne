...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.customer'
        db.alter_column(u'core_review', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Customer'], null=True))

        # Changing field 'Review.business'
        db.alter_column(u'core_review', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Business'], null=True))

    def backwards(self, orm):

        # Changing field 'Review.customer'
        db.alter_column(u'core_review', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Customer']))

        # Changing field 'Review.business'
        db.alter_column(u'core_review', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Business']))
