...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.create_date'
        db.alter_column(u'core_review', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Review.create_date'
        db.alter_column(u'core_review', 'create_date', self.gf('django.db.models.fields.DateTimeField')())
