...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Business.features'
        db.delete_column(u'core_business', 'features_id')

        # Adding M2M table for field features on 'Business'
        m2m_table_name = db.shorten_name(u'core_business_features')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('business', models.ForeignKey(orm[u'core.business'], null=False)),
            ('features', models.ForeignKey(orm[u'core.features'], null=False))
        ))
        db.create_unique(m2m_table_name, ['business_id', 'features_id'])


    def backwards(self, orm):
        # Adding field 'Business.features'
        db.add_column(u'core_business', 'features',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Features'], null=True),
                      keep_default=False)

        # Removing M2M table for field features on 'Business'
        db.delete_table(db.shorten_name(u'core_business_features'))
    ...
    models = {
        ...
        u'core.business': {
            ...
            'business_photos': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.BusinessPhoto']", 'null': 'True'}),
