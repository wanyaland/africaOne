...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_business', (
            ...
            ('city', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=12, null=True)),
            ('web_address', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ...
            ('location', self.gf('geoposition.fields.GeopositionField')(max_length=42, null=True)),
        ...
        db.create_table(u'core_customer', (
            ...
            ('photo', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
        ))
        ...
        db.create_table(u'core_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
    ...
    models = {
        ...
        u'core.customer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
