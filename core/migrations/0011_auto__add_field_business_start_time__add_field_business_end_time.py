...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.start_time'
        db.add_column(u'core_business', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'Business.end_time'
        db.add_column(u'core_business', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.start_time'
        db.delete_column(u'core_business', 'start_time')

        # Deleting field 'Business.end_time'
        db.delete_column(u'core_business', 'end_time')
