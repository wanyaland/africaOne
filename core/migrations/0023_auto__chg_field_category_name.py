...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'Category.name'
        db.alter_column(u'core_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'core.category': {
            ...
            'parent_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Category']", 'null': 'True', 'blank': 'True'})
        },
        u'core.customer': {
